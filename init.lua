...
-- Ruby (I use chruby)
if vim.env.GEM_HOME or not #vim.env.GEM_HOME == 0 then
  vim.g.ruby_host_prog = vim.env.GEM_HOME .. '/bin/neovim-ruby-host'
end
...
-- Show line numbers at same time as the relative numbers
